from Pulse_v2 import fake_spectrometer, fake_motor, fake_attenuator, motor, spectrometer, attenuator, generic_wave_plate, pulse_shaper_obj, simulator, generic_wave_plate, time_delay, polarising_beam_splitter, chirp_filter 
...
hyp_scan = hds.hyper_scan([ps_control, att_control,ps_control_2,att_control_2,time_delay_control,hwp_control],measururement_control=spec_control)

gui = gui_manager([ps_control, att_control,ps_control_2,att_control_2,time_delay_control,hwp_control, spec_control,sim_control,opti_control,hyp_scan],num_coloums=2)
gui.start_gui()
